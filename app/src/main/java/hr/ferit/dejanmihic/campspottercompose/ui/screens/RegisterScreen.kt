...
fun RegisterScreenV2(
    ...
    Auth(
        messageTitleId = R.string.auth_sign_up_message_title,
        confirmLabelId = R.string.auth_sign_up_label_confirm,
        bottomMessageId = R.string.auth_sign_up_bottom_message,
        navigateLabelId = R.string.auth_sign_up_label_navigate,
        email = email,
